...
public class FormulaAtom {
    ...
    private FORule tgd;
    private ConstantFORule constantTgd;
    ...
    public FormulaAtom(SetAlias variable, ConstantFORule tgd) {
        this.variable = variable;
        this.constantTgd = tgd;
    }
    ...
    public String toString() {
        ...
        if (tgd != null){
            ...
            result.append(" - constant tgd: ").append(constantTgd.getId());
        }
