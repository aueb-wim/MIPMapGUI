...
public class Subsumption {
    ...
    private ConstantFORule leftConstantTgd;
    private ConstantFORule rightConstantTgd;
    ...
    public Subsumption(ConstantFORule leftTgd, ConstantFORule rightTgd, List<VariableCorrespondence> leftCorrespondences, List<VariableCorrespondence> rightCorrespondences) {
        this.leftConstantTgd = leftTgd;
        this.rightConstantTgd = rightTgd;
        this.leftCorrespondences = leftCorrespondences;
        this.rightCorrespondences = rightCorrespondences;
    }
    ...
    public String toString(String indent) {
        ...
        if (rightTgd != null){
            ...
            result.append(rightConstantTgd.toString(indent));
        }
