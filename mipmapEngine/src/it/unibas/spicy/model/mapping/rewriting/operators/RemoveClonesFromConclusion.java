...
public class RemoveClonesFromConclusion {
    ...
    private VariableJoinCondition removeClones(VariableJoinCondition joinCondition) {
        ...
        VariableJoinCondition newJoin = new VariableJoinCondition(newFromPaths, newToPaths, joinCondition.isMonodirectional(), joinCondition.isMandatory(), joinCondition.isMatchString());
        return newJoin;
    }
