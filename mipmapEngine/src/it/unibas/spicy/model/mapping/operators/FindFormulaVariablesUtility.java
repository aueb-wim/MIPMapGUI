        ...
        for (VariableJoinCondition joinCondition : allJoins) {
            if (joinCondition.isSimple()) {
                ...
                for (int i = 0; i < joinCondition.size(); i++) {
                    ...
                    VariableJoinCondition newJoin = new VariableJoinCondition(fromPath, toPath, joinCondition.isMonodirectional(), joinCondition.isMandatory(), joinCondition.isMatchString());
                    result.add(newJoin);
                }
            }
        }
