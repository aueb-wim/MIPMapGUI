...
public class JoinCondition implements Cloneable {
    ...
    public JoinCondition(List<PathExpression> fromPaths, List<PathExpression> toPaths, boolean monodirectional) {
        this(fromPaths, toPaths, monodirectional, false);
    }
    
    public JoinCondition(List<PathExpression> fromPaths, List<PathExpression> toPaths, boolean monodirectional, boolean mandatory) {
        this(fromPaths, toPaths, monodirectional, monodirectional, false);
    }

    public JoinCondition(List<PathExpression> fromPaths, List<PathExpression> toPaths, boolean monodirectional, boolean mandatory, boolean matchString) {
    ...
    public void setMatchString(boolean matchString) {
        this.matchString = matchString;
    }
    ...
    public String toString() {
        ...
        result.append(" (matchString = ").append(matchString).append(")");
