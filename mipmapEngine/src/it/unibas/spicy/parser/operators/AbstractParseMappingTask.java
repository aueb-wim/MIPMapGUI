...
abstract class AbstractParseMappingTask implements IParseMappingTask {
    ...
    public void createMappingTask(int scenarioNo, List<String> sourceSchemaFiles, List<String> sourceInstanceFiles, String targetSchemaFile) throws Exception {
        try {
            ...
            for (int i = 0; i < sourceSchemaFiles.size(); i++) {
                ...
                if (sourceSchemaFile.equalsIgnoreCase(GENERATE)) {
                    ...
                    MappingTask previousStep = loadMappingTask(scenarioNo, previousStepFilePath);
