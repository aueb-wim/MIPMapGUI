...
import org.nfunk.jep.function.IndexOf;
import org.nfunk.jep.function.IsNotNull;
import org.nfunk.jep.function.IsNull;
import org.nfunk.jep.function.Length;
...
import org.nfunk.jep.function.Split;
import org.nfunk.jep.function.SquareRoot;
import org.nfunk.jep.function.Str;
import org.nfunk.jep.function.Substring;
 ...
 */
public class JEP implements Cloneable {
    ...
    public Object clone() {
        try {
            JEP clone = (JEP) super.clone();
            clone.symTab = (SymbolTable) this.symTab.clone();
            if (funTab != null) {
                clone.funTab = (FunctionTable) this.funTab.clone();
            }
            clone.errorList = new Vector(this.errorList);
            if (topNode != null) {
                clone.topNode = (Node) this.topNode.clone();
            }
            clone.ev = new EvaluatorVisitor();
    ...
    public void addStandardFunctions() {
        ...
        funTab.put("toupper", new ToUppercase());
    ...
    public void addStandardConstants() {
        ...
        symTab.addConstant("true", new Integer(1));
        symTab.addConstant("false", new Integer(0));
    }
    ...
    public String toStringWithSlashes() {
    ...
    public String toStringForSql() {
        return new ExpressionToString().toStringForSql(this);
    }
