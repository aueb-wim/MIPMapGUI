...
public class ExpressionToString {
    ...
    public String toStringWithSlashes(JEP jepExpression) {
        try {
            ToStringVisitor visitor = new ToStringVisitor(jepExpression, true, true, false);
            if (jepExpression == null || jepExpression.getTopNode() == null) {
                return null;
            }
            jepExpression.getTopNode().jjtAccept(visitor, null);
        ...
        public String toStringForSql(JEP jepExpression) {
        try {
    ...
    public String toStringWithDollars(JEP jepExpression) {
        try {
            ToStringVisitor visitor = new ToStringVisitor(jepExpression, false, true, false);
            if (jepExpression == null || jepExpression.getTopNode() == null) {
                return null;
            }
            jepExpression.getTopNode().jjtAccept(visitor, null);
...
class ToStringVisitor implements ParserVisitor {
    ...
    public ToStringVisitor(JEP jepExpression, boolean withSlashes, boolean withDollar, boolean forSql) {
        this.jepExpression = jepExpression;
    ...
    public ToStringVisitor(JEP jepExpression, boolean withSlashes, boolean withDollar, boolean absolutePaths, boolean forSql) {
        this.jepExpression = jepExpression;
        this.withSlashes = withSlashes;
        this.withDollar = withDollar;
    ...
    public Object visit(ASTFunNode node, Object data) throws ParseException {
        if (isOperator(node)) {
            ...
            else if (this.withSlashes && node.getXQueryName().equals("fn:tokenize")) {
                result.append("]");
            } else {
                result.append(")");
            }
