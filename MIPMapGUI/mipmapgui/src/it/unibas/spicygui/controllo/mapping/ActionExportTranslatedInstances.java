...
public class ActionExportTranslatedInstances extends CallableSystemAction implements Observer {
    ...
    public ActionExportTranslatedInstances() {
        executeInjection();
        this.putValue(SHORT_DESCRIPTION, NbBundle.getMessage(Costanti.class, Costanti.ACTION_EXPORT_TRANSLATED_INSTANCES_XML));
    ...
    public String getName() {
        return NbBundle.getMessage(Costanti.class, Costanti.ACTION_EXPORT_TRANSLATED_INSTANCES_XML);
    }
