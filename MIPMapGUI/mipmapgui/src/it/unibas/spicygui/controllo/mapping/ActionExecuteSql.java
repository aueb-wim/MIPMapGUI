        ...
        if (dialog.getReturnStatus() == SqlDialog.RET_OK) {
            ...
            try {
                ...
                if (dialog.isRecreate()) {
                    ...
                    new ExecuteSQL().executeScript(mappingTask, relationalConfigurationPM.getAccessConfiguration(), accessConfigurationSupport, textArea.getText(), sourceSQLScriptReader, sourceInstanceSQLScriptReader, targetSQLScriptReader, null,scenarioNo);
                } else {
                    new ExecuteSQL().executeScript(mappingTask, relationalConfigurationPM.getAccessConfiguration(), textArea.getText(), sourceSQLScriptReader, sourceInstanceSQLScriptReader, targetSQLScriptReader, null,scenarioNo);
                }
