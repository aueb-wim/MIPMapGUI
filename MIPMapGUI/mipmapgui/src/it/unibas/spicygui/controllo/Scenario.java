...
public class Scenario extends AbstractScenario  {
    ...
    private transient ConstantFORule selectedConstantFORule;
...
//        this.instancesTopComponent = new InstancesTopComponent(this);
    ...
    public ConstantFORule getSelectedConstantFORule() {
        return selectedConstantFORule;
    }
    
    public void setSelectedConstantFORule(ConstantFORule selectedConstantFORule) {
        this.selectedConstantFORule = selectedConstantFORule;
    }
