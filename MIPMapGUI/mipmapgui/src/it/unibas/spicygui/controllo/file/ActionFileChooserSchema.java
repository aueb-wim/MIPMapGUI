...
public class ActionFileChooserSchema extends AbstractAction {

    private static Log logger = LogFactory.getLog(ActionFileChooserSchema.class);
    private Modello modello;
    private Vista vista;
    private XMLConfigurationPM xmlConfigurationPM;

    public ActionFileChooserSchema() {
        super("...");
    }
