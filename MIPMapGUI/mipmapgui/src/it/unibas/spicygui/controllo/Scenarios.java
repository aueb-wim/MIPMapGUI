...
public class Scenarios extends Observable {
    ...
    public boolean removeScenario(IScenario scenario) {
        ...
        if (esito) {
            releaseNumber((Integer) scenario.getNumber());
        }
        setChanged();
        notifyObservers(scenario);
        return esito;
    ...
    public static int getNextFreeNumber() {
        ...
        lastScenarioNo = contatore;
        return contatore;
    }
    
    public static void releaseNumber(Integer no) {
        listaNumeri.remove(no);
    }
    
    public static void releaseNumber() {
        releaseNumber((Integer) lastScenarioNo);
    }
}
