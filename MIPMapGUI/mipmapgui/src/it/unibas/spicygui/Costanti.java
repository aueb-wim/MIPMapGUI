...
public class Costanti {
    ...
    public static final String ACTION_EXPORT_TGDS="ACTION_EXPORT_TGDS";
    ...
    public static final String ACTION_EXPORT_TRANSLATED_INSTANCES_SQL = "ACTION_EXPORT_TRANSLATED_INSTANCES_SQL";
    ...
    public static final String EXPORT_TGDS = "EXPORT_TGDS";
    ...
    public static final String TOGGLE_MATCH_STRING = "TOGGLE_MATCH_STRING";
    ...
    public static final String EXPORT_COMPLETED_OK="EXPORT_COMPLETED_OK";
    //Translate
    ...
    public static final Color COLOR_CONNECTION_CONSTRAINT_MATCHSTRING = Color.BLUE;
