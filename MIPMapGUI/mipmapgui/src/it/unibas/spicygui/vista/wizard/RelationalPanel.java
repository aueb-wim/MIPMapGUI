...
public class RelationalPanel extends javax.swing.JPanel {
    ...
    //giannisk
    //set Uri text according to Driver selection
    private void comboDriverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboDriverActionPerformed
       Object selection = comboDriver.getSelectedItem();
       if (selection!=null){
        String selectionUri = selection.toString();
        String driver="";
        if(selectionUri.equals("org.postgresql.Driver")){
            driver="postgresql";            
         }
         else if(selectionUri.equals("com.mysql.jdbc.Driver")){
             driver="mysql";
         }
