...
import it.unibas.spicygui.controllo.validators.ValidatoreWizardStep2Target;
...
public class NewMappingTaskWizardPanel2 implements WizardDescriptor.Panel {
    ...
    public boolean isValid() {
        ...
        if (ValidatoreWizardStep2Target.verifica()) {
            return true;
        }
        return false;
//        return true;
