...
public class JoinConstraint {
    ...
    public void deleteAll() {
        ...
        dataSource.removeJoinCondition(this.joinCondition);
    }
    ...
    public void changeMatchString(boolean matchString) {
        for (ConnectionConstraint connectionConstraint : connections) {
            connectionConstraint.changeMatchString(matchString, joinCondition.toString());
        }
    }
