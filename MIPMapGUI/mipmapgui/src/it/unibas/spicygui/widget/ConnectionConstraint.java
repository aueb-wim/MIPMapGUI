...
public class ConnectionConstraint {
    ...
    private String suffixMatchString;
    ...
    public void changeMandatory(boolean mandatory, String joinString) {
        this.suffixMandatory = Boolean.toString(mandatory);
...
//            connectionWidget.setToolTipText("Mandatory = " + this.suffixMandatory + " Monodirectional = " + this.suffixForeignKey);
    ...
    public void changeMatchString(boolean matchString, String joinString) {
        this.suffixMatchString = Boolean.toString(matchString);
        this.joinString = joinString;
        for (ConnectionWidget connectionWidget : connections) {
            connectionWidget.setToolTipText(joinString);
            if (matchString) {
                connectionWidget.setLineColor(Costanti.COLOR_CONNECTION_CONSTRAINT_MATCHSTRING);
            } else {
               connectionWidget.setLineColor(Costanti.COLOR_CONNECTION_CONSTRAINT_DEFAULT);
            }
        }
    }
